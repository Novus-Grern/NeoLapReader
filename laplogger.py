...
def openLog(): 
	#should check if log file exists already 
	# Create a log name based on the curent vehicle-track combination

	timestamp = time.strftime("%Y%m%d-%H%M%S")
	LOG_NAME = "{}-{}-{}-{}.log".format(ac.getCarName(0), ac.getTrackName(0), ac.getTrackConfiguration(0), timestamp) 
